...
Движком BEMTREE используются все те же режимы, что и движком BEMHTML. Разница
только в формате результата: для BEMHTML на выходе получается HTML, для BEMTREE
— BEMJSON.
